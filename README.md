...
This repository contains sample for login screen with applying gradient background using the [Syncfusion Xamarin.Forms Gradient View](https://help.syncfusion.com/xamarin/gradient-view/getting-started) control.
